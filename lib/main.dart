...
import 'package:consulting_app/UI/Screens/reservation.dart';
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (BuildContext context) => ConsultingCubit()
            ..getUserData() //..getHomeData(id)/*..getCategories()*/..getFavorites() ..getUserData(),),
          ,
        ),
        BlocProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/expertprofile': (context) => ExpertProfileScreen(),
        },
        home: null,
      ),
    );
